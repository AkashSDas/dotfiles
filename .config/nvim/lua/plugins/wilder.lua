return {
	{
		...
		config = function()
			...
			-- Manually define Gruvbox colors (these are from Gruvbox Dark)
			...
			-- Create a highlight group for the popup menu
			local text_highlight =
				wilder.make_hl("WilderText", { { a = 1 }, { a = 1 }, { foreground = gruvbox_colors.grey } })
			local mauve_highlight =
				wilder.make_hl("WilderMauve", { { a = 1 }, { a = 1 }, { foreground = gruvbox_colors.purple } })
